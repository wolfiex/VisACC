...
declare module "electron-builder/out/builder" {
  ...
  export function createPublisher(packager: Packager, options: PublishOptions, publishConfig: PublishConfiguration | GithubOptions | BintrayOptions, isPublishOptionGuessed?: boolean): Promise<Publisher | null>
}
...
declare module "electron-builder/out/publish/gitHubPublisher" {
  ...
  export class GitHubPublisher implements Publisher {
    ...
    constructor(owner: string, repo: string, version: string, options: PublishOptions, isPublishOptionGuessed?: boolean, config?: GithubOptions | null)
