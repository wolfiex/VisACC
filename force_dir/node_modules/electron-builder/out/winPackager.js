...
class WinPackager extends platformPackager_1.PlatformPackager {
    ...
    packageInDistributableFormat(outDir, appOutDir, arch, targets, promises) {
        for (let target of targets) {
            if (target instanceof platformPackager_1.TargetEx) {
                promises.push(log_1.task(`Building ${ target.name } ${ metadata_1.Arch[arch] } installer`, target.build(appOutDir, arch)));
            } else {
