...
.style('fill','white')
  ...
  .links(links)
  .distance( function(d) {return d.v} )
  .strength(0)
  ...
  .tween('strength', function() {
    ...
    return function(t) { simulation.force("link").strength(i(t));}
  });
  ...
  setTimeout(function(){simulation.force("link").strength(1)}, 1000);
  ...
  function ticked() {
    ...
    */
    ...
    if (rsz){
      if (simulation.alpha() < 0.18) {resize();rsz=false}
    }
